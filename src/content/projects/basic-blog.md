...
image:
  src: >-
    https://lt-20260522-042729105-basic-blog-01-9105-3bb13fcb.pages.dev/images/placeholder-card.svg
  alt: >-
    Screenshot of the "Basic Blog Load Test 01 20260522-042729105" blog homepage featuring a dark UI and three featured articles with hand-drawn, sketch-style illustrations on a textured tan background. 
ogImage:
  src: https://lt-20260522-042729105-basic-blog-01-9105-3bb13fcb.pages.dev/images/placeholder-card.svg
---
...
export const SITE_SETTINGS = {
  title: "Basic Blog Load Test 01 20260522-042729105 site",
  description: "A space to explore ideas and share what I'm learning",
  owner: "Basic Blog Load Test 01 20260522-042729105",
  ogImages:
    "https://lt-20260522-042729105-basic-blog-01-9105-3bb13fcb.pages.dev/images/placeholder-card.svg",
  socials: [
    {
      icon: "github",
      label: "GitHub",
      url: "https://github.com/lt-20260522-042729105-basic-blog-01-9105-3bb13fcb",
      handle: "lt-20260522-042729105-basic-blog-01-9105-3bb13fcb",
    },
  ],
};
```
...
<BaseLayout
    title="Search"
    description="Search articles and projects from Basic Blog Load Test 01 20260522-042729105."
		...
		handler: async ({ name, email, message, 'cf-turnstile-response': token }, ctx) => {
			...
			try {
				const { data, error } = await resend.emails.send({
					from: 'Contact Form <contact@mail.lt-20260522-042729105-basic-blog-01-9105-3bb13fcb.com>',
					to: ['lt-20260522-042729105-basic-blog-01-9105-3bb13fcb@gmail.com'],
					...
					html: `
						...
						<p>${escapeMessage}</p>
						<p style="color:#666">Sent from lt-20260522-042729105-basic-blog-01-9105-3bb13fcb.com</p>
                    `,
					text:
						...
						`Email: ${safeEmail}\n\n` +
						`Message:\n${messag}\n` +
						'— Sent from lt-20260522-042729105-basic-blog-01-9105-3bb13fcb.com',
				});
